// <copyright file="MCSLoginErrorTest.cs" company="PlaceholderCompany">
...
namespace MCS.Test.Automation.Tests.NUnit.Tests
{
    ...
    [TestFixture]
    public class MCSLoginErrorTest : ProjectTestBase
    {
        [Test]
        [Category("Ignore")]
        ...
        public void VerifyuserAbletoLoginWithoutUserDetailsTest(Dictionary<string, string> parameters)
        {
