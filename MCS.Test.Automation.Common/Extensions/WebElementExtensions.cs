// <copyright file="WebElementExtensions.cs" company="MCS">
...
namespace MCS.Test.Automation.Common.Extensions
{
    ...
    public static class WebElementExtensions
    {
        ...
        {
            var aa = webElement.Text;
            var aa1 = webElement.GetAttribute("value");
            var aa12 = webElement.GetAttribute("text");

            Console.WriteLine(aa);
            Console.WriteLine(aa1);
            Console.WriteLine(aa12);
