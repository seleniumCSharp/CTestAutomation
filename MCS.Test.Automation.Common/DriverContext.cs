// <copyright file="DriverContext.cs" company="MCS">
...
namespace MCS.Test.Automation.Common
{
    ...
    public class DriverContext
    {
        ...
        /// <summary>
        /// Gets or sets gets or Set the test
        /// </summary>
        /// <value>
        /// The test title.
        /// </value>
...
#pragma warning restore SA1201 // Elements must appear in the correct order
        ...
        /// <summary>
        /// Gets Sets Folder name for ExtentReports
        /// </summary>
        public string ExtentReportFolder
        {
            get
            {
                return FilesHelper.GetFolder(BaseConfiguration.ExtentReportFolder, this.CurrentDirectory);
            }
        }
        ...
        /// Gets Sets Folder name for ExtentReports
        /// </summary>
        public string MethodJsonFolder
        {
            get
            {
                return FilesHelper.GetFolder(BaseConfiguration.MethodJsonFolder, this.CurrentDirectory);
            }
        }
        ...
        /// Gets Sets Folder name for ExtentReports
        /// </summary>
        public string SuiteJsonFolder
        {
            get
            {
                return FilesHelper.GetFolder(BaseConfiguration.SuiteJsonFolder, this.CurrentDirectory);
            }
        }
        ...
        private FirefoxOptions FirefoxOptionsForAutomaticDownLoad
        {
            get
            {
        ...
        private FirefoxOptions FirefoxOptions
        {
            get
            {
                ...
                // disable Firefox's built-in PDF viewer
                options.SetPreference("pdfjs.disabled", false);
        ...
        private ChromeOptions ChromeOptionsForAutomaticDownLoad
        {
            get
            {
                ChromeOptions options = new ChromeOptions();
                ...
                options.AddUserProfilePreference("download.default_directory", Path.GetFullPath(this.DownloadFolder));
                options.AddUserProfilePreference("profile.default_content_settings.popups", 0);
                options.AddUserProfilePreference("download.default_directory", this.DownloadFolder);
                options.AddUserProfilePreference("download.prompt_for_download", false);
        ...
        private InternetExplorerOptions InternetExplorerOptions
        {
            get
            {
                ...
                options.AddAdditionalCapability("browser.download.dir", this.DownloadFolder);
                options.AddAdditionalCapability("download.default_directory", this.DownloadFolder);
                options.AddAdditionalCapability("browser.download.folderList", 0);
                options.AddAdditionalCapability("plugins.always_open_pdf_externally", true);
                ...
                options.AddAdditionalCapability("browser.helperApps.neverAsk.saveToDisk", "application/msword, application/csv, application/ris, text/csv, image/png, application/pdf, text/html, text/plain, application/zip, application/x-zip, application/x-zip-compressed, application/download, application/octet-stream");
        ...
        /// </summary>
        /// <param name="browserType">To get the driver</param>
        /// <param name="setAutoDownload">Sets the Auto Download in a Browser to true or false</param>
        /// <exception cref="NotSupportedException">When driver not supported</exception>
        [SuppressMessage("Microsoft.Design", "CA1026:DefaultParametersShouldNotBeUsed", Justification = "Need to Add")]
        ...
        public void Start(BrowserType browserType, bool setAutoDownload = false)
        {
            switch (browserType)
            {
                case BrowserType.Firefox:
                    if (setAutoDownload == false)
                    {
                    ...
                    {
                        this.driver = new FirefoxDriver(this.SetDriverOptions(this.FirefoxOptionsForAutomaticDownLoad));
                    }
                ...
                case BrowserType.Chrome:
                    ...
                    {
                        this.driver = new ChromeDriver(this.SetDriverOptions(this.ChromeOptionsForAutomaticDownLoad));
                        this.WindowMaximize();
                    }
